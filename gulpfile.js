...
gulp.task('lintJS', function () {
    ...
    return gulp.src(['./client/*.module.js','./client/*.js','./client/**/*.js','./client/components/**/*.js', './server/**/*.js'])
        .pipe(plumber({
...
gulp.task('buildJS', ['lintJS'], function () {
    return gulp.src(['./client/*.module.js','./client/*.js','./client/**/*.js','./client/components/**/*.js'])
        .pipe(plumber())
...
gulp.task('default', function () {
    ...
    gulp.watch(['client/**','client/**/*.js','client/components/**/*.js'], function () {
